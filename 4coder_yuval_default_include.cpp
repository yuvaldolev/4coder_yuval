/*
4coder_yuval_default_include.cpp - Yuval's default set of commands and setup used in 4coder.
*/
...
# include "4coder_yuval_code_index.h"
#else
...
#if USE_YUVAL_CODE_INDEX
# include "4coder_yuval_code_index.cpp"
#else
